...
// En aattribuant un valeur à un paramètre (ex: taux=20), il devient optionnel au moment de 
// l'appel de la fonction et aura une valeur par défaut 
...
let fruits = ['banane','raisins','pomme','mangue'];
console.log(fruits);
let legumes = new Array('carotte','aubergine','poireau');//je cré un nouveau tableau de type array et je le met dans legumes
console.log(legumes);

document.write(fruits[2] + '<br>');
document.write(`Mon tabeaux fruits contient ${fruits.length} elements<br>`);
// on veut rajouter un fuit à notre liste 

fruits.push('pêche'); //push() permet d'ajouter un ou des éléments
console.log(fruits);

document.write(fruits.join(', ')); // liste les éléments avec un séparateur entre chaque (ici un virgule et un espace)

// Rappel : indexOf() losrqu'il ne trouve pas il renvoie un -1 ,exemple:
console.log(fruits.indexOf('citron'));
// Renvoie l'index de l'élément citron ,ici il renvoie 2 s'il trouves pas le fruit il revoie -1 
console.log(fruits.indexOf('raisin')); 
// includes renvoie un booléen qui indique si l'élément est inclus dans le tableaux ou pas 
...
// Retier le premier élément ( numéro 0)
fruits.shift();
console.log(fruits); // équivalent à fruits.splice(0,1)

//fruits.pop();
//équivalent fruits.splice(fruits.length-1,1);

//retier les 4 derniers
//fruits1.splice(fruits.length-4,4); 
